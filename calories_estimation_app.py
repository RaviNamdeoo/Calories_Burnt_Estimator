...
duration = st.number_input('Exercise Duration (minutes)', min_value=1.0, max_value=300.0, value=15.0, step=1.0)
heart_rate = st.number_input('Heart Rate (bpm)', min_value=40.0, max_value=200.0, value=100.0, step=1.0)
