...
weight = st.number_input('Weight (kg)', min_value=35.0, max_value=200.0, value=70.0)
duration = st.number_input('Exercise Duration (minutes)', min_value=1.0, max_value=300.0, value=15.0)
